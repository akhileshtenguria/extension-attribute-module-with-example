...
class Index extends Action
{
    ...
    public function execute()
    {
        try {
            ...
            // print_r(get_class_methods($customer->getExtensionAttributes()));
            print_r($customer->getExtensionAttributes()->getExampleText());
            echo "<br>";
            print_r($customer->getExtensionAttributes()->getExampleObject());
